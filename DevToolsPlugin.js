...
await chrome.devtools.performance.onProfilingStarted.addListener(a => {
...
function registerPluginData(data) {
    ...
    chrome.devtools.performance.registerPerformanceExtensionData(new ExtensionPlugin(timeOrigin, entries), 'Corgi Collage Backend Extension')
}
